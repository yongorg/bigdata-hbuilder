...
function initEcharts(pName, Chinese_) {
	...
	var tmpSeriesData_count = seriesData_count;
	var tmpSeriesData_salary = seriesData_salary;
	var tmpSeriesData_year = seriesData_year;
	var option = {
		title: {
			text: Chinese_ || pName,
			left: 'center'
